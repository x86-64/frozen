 ...
 *    @li Fuse filesystem for input and ouput
 *    @li Storage in memory or file
 *    @li Memory caches
 *    @li Indexes, lookup tables
 *    @li Pack/unpack from defined structure
 *    @li Ipc
 *    @li Load balancing
 *    @li Benchmarks
 *
 ...
 *        
 *    @li Reduce communication within single machine
 *
 ...
 *  
 *  To understand architecture read @ref backend, @ref api, @ref data. 
 *  
 */
