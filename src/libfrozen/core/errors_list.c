...
static err_item errs_list[] = {
 ...
 { -156034, "src/libfrozen/machines/io/console/console.c: input key not supplied" },
 { -156020, "src/libfrozen/machines/io/console/console.c: input key not supplied" },
 { -156006, "src/libfrozen/machines/io/console/console.c: output key not supplied" },
 ...
 { -57627, "src/libfrozen/machines/machine/pool/pool.c: config not supplied" },
 { -57607, "src/libfrozen/machines/machine/pool/pool.c: calloc failed" },
