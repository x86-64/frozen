...
static err_item errs_list[] = {
 ...
 { -49163, "src/libfrozen/backends/mphf/mphf_chm_imp.c: backend chm_imp parameter backend_g invalid" },
 { -49162, "src/libfrozen/backends/mphf/mphf_chm_imp.c: v array fill failed" },
 { -49161, "src/libfrozen/backends/mphf/mphf_chm_imp.c: v array file not empty" },
 { -49160, "src/libfrozen/backends/mphf/mphf_chm_imp.c: v array create failed" },
 { -49159, "src/libfrozen/backends/mphf/mphf_chm_imp.c: g array fill failed" },
 { -49158, "src/libfrozen/backends/mphf/mphf_chm_imp.c: g array file not empty" },
 { -49157, "src/libfrozen/backends/mphf/mphf_chm_imp.c: g array create failed" },
 { -49156, "src/libfrozen/backends/mphf/mphf_chm_imp.c: v array delete failed" },
 { -49155, "src/libfrozen/backends/mphf/mphf_chm_imp.c: e array delete failed" },
 { -49154, "src/libfrozen/backends/mphf/mphf_chm_imp.c: g array delete failed" },
 { -49153, "src/libfrozen/backends/mphf/mphf_chm_imp.c: params write failed" },
 { -49152, "src/libfrozen/backends/mphf/mphf_chm_imp.c: params read failed" },
