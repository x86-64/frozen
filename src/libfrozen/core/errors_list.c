...
static err_item errs_list[] = {
 { -61448, "src/libfrozen/backends/balancer/balancer.c: fork failed" },
 { -61447, "src/libfrozen/backends/balancer/balancer.c: invalid childs count" },
 ...
 { -16389, "src/libfrozen/backends/cache/cache.c: invalid mode_perfork supplied" },
