...
static err_item errs_list[] = {
 ...
 { -114899, "src/libfrozen/backends/data/regexp/regexp.c: can not convert data to string" },
 { -114894, "src/libfrozen/backends/data/regexp/regexp.c: no input string in request" },
 { -114798, "src/libfrozen/backends/data/regexp/regexp.c: calloc failed" },
 { -114779, "src/libfrozen/backends/data/regexp/regexp.c: can not copy marker data" },
 { -114760, "src/libfrozen/backends/data/regexp/regexp.c: invalid regexp supplied - compilation error" },
