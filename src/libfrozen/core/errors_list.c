...
static err_item errs_list[] = {
 ...
 { -102671, "src/libfrozen/machines/machine/rebuild/rebuild.c: not writer supplied" },
 { -102669, "src/libfrozen/machines/machine/rebuild/rebuild.c: not reader supplied" },
 { -102666, "src/libfrozen/machines/machine/rebuild/rebuild.c: no writer supplied" },
 { -102663, "src/libfrozen/machines/machine/rebuild/rebuild.c: no reader supplied" },
 { -102642, "src/libfrozen/machines/machine/rebuild/rebuild.c: calloc failed" },
 { -102566, "src/libfrozen/machines/machine/rebuild/rebuild.c: calloc failed" },
