...
static err_item errs_list[] = {
 ...
 { -159996, "src/libfrozen/backends/io/console/console.c: input key not supplied" },
 { -159986, "src/libfrozen/backends/io/console/console.c: input key not supplied" },
 { -159964, "src/libfrozen/backends/io/console/console.c: calloc failed" },
 { -159950, "src/libfrozen/backends/io/console/console.c: pthread_create failed" },
 { -159919, "src/libfrozen/backends/io/console/console.c: pthread_join failed" },
 { -159916, "src/libfrozen/backends/io/console/console.c: pthread_cancel failed" },
 { -159898, "src/libfrozen/backends/io/console/console.c: calloc failed" },
 ...
 { -114860, "src/libfrozen/backends/data/regexp/regexp.c: can not convert data to string" },
 { -114855, "src/libfrozen/backends/data/regexp/regexp.c: no input string in request" },
 ...
 { -8841, "src/libfrozen/backends/storage/file/file.c: no buffer supplied" },
 { -8808, "src/libfrozen/backends/storage/file/file.c: file_update_count failed" },
 { -8805, "src/libfrozen/backends/storage/file/file.c: no buffer supplied" },
 { -8770, "src/libfrozen/backends/storage/file/file.c: io error" },
 { -8760, "src/libfrozen/backends/storage/file/file.c: malloc error" },
 { -8757, "src/libfrozen/backends/storage/file/file.c: size is null" },
 { -8734, "src/libfrozen/backends/storage/file/file.c: file_update_count failed" },
 { -8729, "src/libfrozen/backends/storage/file/file.c: offset_to not supplied" },
 { -8728, "src/libfrozen/backends/storage/file/file.c: offset_from not supplied" },
 { -8701, "src/libfrozen/backends/storage/file/file.c: cant delete not last elements" },
 { -8693, "src/libfrozen/backends/storage/file/file.c: file_update_count failed" },
 { -8686, "src/libfrozen/backends/storage/file/file.c: size not supplied" },
 { -8685, "src/libfrozen/backends/storage/file/file.c: offset not supplied" },
 { -8656, "src/libfrozen/backends/storage/file/file.c: file expand error" },
 { -8650, "src/libfrozen/backends/storage/file/file.c: size not supplied" },
 { -8646, "src/libfrozen/backends/storage/file/file.c: size not supplied" },
