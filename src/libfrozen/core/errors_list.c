...
static err_item errs_list[] = {
 ...
 { -49870, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: delete not supported" },
 { -49623, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: recalc db inconsistency" },
 { -49593, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: set_g failed" },
 { -49577, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: get_g failed" },
 { -49559, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: find_edge db inconsistency" },
 { -49532, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: set_edge failed" },
 { -49505, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: get_edge failed" },
 { -49487, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: set first failed" },
 { -49472, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: get_first failed" },
 { -49454, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: new_edge_id failed" },
 { -49431, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: mphf is read-only" },
 { -49393, "src/libfrozen/machines/index/mphf/mphf_chm_imp.c: too many elements" },
