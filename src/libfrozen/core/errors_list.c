...
static err_item errs_list[] = {
 ...
 { -40967, "src/libfrozen/backends/ipc/ipc_shmem.c: pthread_create failed" },
 { -40966, "src/libfrozen/backends/ipc/ipc_shmem.c: force_async with force_sync" },
 ...
 { -32772, "src/libfrozen/backends/allocator/allocator.c: no size_old supplied" },
 { -32771, "src/libfrozen/backends/allocator/allocator.c: no size supplied" },
 { -32770, "src/libfrozen/backends/allocator/allocator.c: no offset supplied" },
 { -32769, "src/libfrozen/backends/allocator/allocator.c: no size supplied" },
 { -32768, "src/libfrozen/backends/allocator/allocator.c: no offset supplied" },
 ...
 { -16390, "src/libfrozen/backends/cache/cache.c: calloc failed" },
 { -16389, "src/libfrozen/backends/cache/cache.c: memory_size failed" },
 { -16388, "src/libfrozen/backends/cache/cache.c: cache delete failed" },
 { -16387, "src/libfrozen/backends/cache/cache.c: size not supplied" },
 { -16386, "src/libfrozen/backends/cache/cache.c: offset not supplied" },
 { -16385, "src/libfrozen/backends/cache/cache.c: memory_grow failed" },
 { -16384, "src/libfrozen/backends/cache/cache.c: no size supplied" },
