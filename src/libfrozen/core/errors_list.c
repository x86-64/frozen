...
static err_item errs_list[] = {
 ...
 { -40971, "src/libfrozen/backends/communication/ipc/ipc_shmem.c: strange error 3" },
 { -40970, "src/libfrozen/backends/communication/ipc/ipc_shmem.c: cant write buffer to ipc memory" },
 { -40969, "src/libfrozen/backends/communication/ipc/ipc_shmem.c: strange error" },
 { -40968, "src/libfrozen/backends/communication/ipc/ipc_shmem.c: pthread_create failed" },
 { -40967, "src/libfrozen/backends/communication/ipc/ipc_shmem.c: shmem_init failed" },
