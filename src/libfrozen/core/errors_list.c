...
static err_item errs_list[] = {
 ...
 { -151654, "src/libfrozen/machines/data/convert/convert.c: input key not supplied" },
 { -151601, "src/libfrozen/machines/data/convert/convert.c: calloc failed" },
 ...
 { -102668, "src/libfrozen/machines/machine/rebuild/rebuild.c: not writer supplied" },
 { -102666, "src/libfrozen/machines/machine/rebuild/rebuild.c: not reader supplied" },
 { -102663, "src/libfrozen/machines/machine/rebuild/rebuild.c: no writer supplied" },
 { -102660, "src/libfrozen/machines/machine/rebuild/rebuild.c: no reader supplied" },
 { -102639, "src/libfrozen/machines/machine/rebuild/rebuild.c: calloc failed" },
 { -102563, "src/libfrozen/machines/machine/rebuild/rebuild.c: calloc failed" },
