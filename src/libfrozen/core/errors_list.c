...
static err_item errs_list[] = {
 ...
 { -147590, "src/libfrozen/backends/data/split/split.c: no input string in request" },
 { -147534, "src/libfrozen/backends/data/split/split.c: calloc failed" },
 { -143424, "src/libfrozen/backends/request/implode/implode.c: calloc failed" },
 ...
 { -122953, "src/libfrozen/backends/index/fill/fill.c: supplied index backend not valid, or not found" },
 { -122931, "src/libfrozen/backends/index/fill/fill.c: calloc failed" },
 ...
 { -90167, "src/libfrozen/backends/index/lookup/lookup.c: supplied index backend not valid, or not found" },
 { -90148, "src/libfrozen/backends/index/lookup/lookup.c: calloc failed" },
 ...
 { -8873, "src/libfrozen/backends/storage/file/file.c: file_update_count failed" },
