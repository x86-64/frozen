...
static err_item errs_list[] = {
 ...
 { -49174, "src/libfrozen/backends/index/mphf/mphf_chm_imp.c: delete not supported" },
 { -49173, "src/libfrozen/backends/index/mphf/mphf_chm_imp.c: recalc db inconsistency" },
 { -49172, "src/libfrozen/backends/index/mphf/mphf_chm_imp.c: set_g failed" },
 { -49171, "src/libfrozen/backends/index/mphf/mphf_chm_imp.c: get_g failed" },
