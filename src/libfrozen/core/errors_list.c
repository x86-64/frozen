...
static err_item errs_list[] = {
 ...
 { -115536, "src/libfrozen/machines/io/fuse/fuse.c: fuse items confguration failed" },
 { -115533, "src/libfrozen/machines/io/fuse/fuse.c: fuse fs creation failed" },
 { -115529, "src/libfrozen/machines/io/fuse/fuse.c: mountpoint not supplied" },
 ...
 { -62005, "src/libfrozen/machines/machine/limit/limit.c: pthread_join failed" },
 { -62001, "src/libfrozen/machines/machine/limit/limit.c: pthread_cancel failed" },
 { -61972, "src/libfrozen/machines/machine/limit/limit.c: pthread_create failed" },
 { -61962, "src/libfrozen/machines/machine/limit/limit.c: calloc failed" },
 ...
 { -4392, "src/libfrozen/data/storage/file/file_t.c: file open() error" },
 { -4373, "src/libfrozen/data/storage/file/file_t.c: filename invalid" },
 { -4365, "src/libfrozen/data/storage/file/file_t.c: filename not supplied" },
 { -4353, "src/libfrozen/data/storage/file/file_t.c: calloc returns null" },
