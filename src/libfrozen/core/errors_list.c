...
static err_item errs_list[] = {
 { -61451, "src/libfrozen/backends/balancer/balancer.c: fork failed" },
 { -61450, "src/libfrozen/backends/balancer/balancer.c: invalid childs count" },
 { -61449, "src/libfrozen/backends/balancer/balancer.c: alloca failed" },
 { -61448, "src/libfrozen/backends/balancer/balancer.c: childs list problems" },
 { -61447, "src/libfrozen/backends/balancer/balancer.c: data_read failed" },
 { -61446, "src/libfrozen/backends/balancer/balancer.c: field not supplied" },
 { -61445, "src/libfrozen/backends/balancer/balancer.c: no childs" },
 { -61444, "src/libfrozen/backends/balancer/balancer.c: malloc failed" },
 { -61443, "src/libfrozen/backends/balancer/balancer.c: fork failed" },
 { -61442, "src/libfrozen/backends/balancer/balancer.c: no memory" },
 ...
 { -16393, "src/libfrozen/backends/cache/cache.c: memory_size failed" },
 { -16392, "src/libfrozen/backends/cache/cache.c: memory_resize failed" },
 { -16391, "src/libfrozen/backends/cache/cache.c: cant delete not last elements" },
 { -16390, "src/libfrozen/backends/cache/cache.c: memory_size failed" },
 { -16389, "src/libfrozen/backends/cache/cache.c: size not supplied" },
 { -16388, "src/libfrozen/backends/cache/cache.c: offset not supplied" },
 { -16387, "src/libfrozen/backends/cache/cache.c: memory_size failed" },
 { -16386, "src/libfrozen/backends/cache/cache.c: memory_grow failed" },
 { -16385, "src/libfrozen/backends/cache/cache.c: no size supplied" },
 ...
 { -8216, "src/libfrozen/backends/file/file.c: file_update_count failed" },
 { -8215, "src/libfrozen/backends/file/file.c: no buffer supplied" },
 { -8214, "src/libfrozen/backends/file/file.c: called fork_only file" },
 { -8213, "src/libfrozen/backends/file/file.c: io error" },
 { -8212, "src/libfrozen/backends/file/file.c: malloc error" },
 { -8211, "src/libfrozen/backends/file/file.c: size is null" },
 { -8210, "src/libfrozen/backends/file/file.c: file_update_count failed" },
 { -8209, "src/libfrozen/backends/file/file.c: offset_to not supplied" },
 { -8208, "src/libfrozen/backends/file/file.c: offset_from not supplied" },
 { -8207, "src/libfrozen/backends/file/file.c: called fork_only file" },
 { -8206, "src/libfrozen/backends/file/file.c: cant delete not last elements" },
 { -8205, "src/libfrozen/backends/file/file.c: file_update_count failed" },
 { -8204, "src/libfrozen/backends/file/file.c: size not supplied" },
 { -8203, "src/libfrozen/backends/file/file.c: offset not supplied" },
 { -8202, "src/libfrozen/backends/file/file.c: called fork_only file" },
 { -8201, "src/libfrozen/backends/file/file.c: file expand error" },
 { -8200, "src/libfrozen/backends/file/file.c: size not supplied" },
 { -8199, "src/libfrozen/backends/file/file.c: called fork_only file" },
 { -8198, "src/libfrozen/backends/file/file.c: called fork_only file" },
 { -8197, "src/libfrozen/backends/file/file.c: called fork_only file" },
