...
static err_item errs_list[] = {
 ...
 { -208973, "src/libfrozen/data/allocator/list/allocator_list_t.c: no item_size nor item_sample supplied" },
 { -208966, "src/libfrozen/data/allocator/list/allocator_list_t.c: invalid storage" },
 { -204888, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: bad underlying storage" },
 { -204881, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: bad item size" },
 { -204874, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: bad item_sample" },
 { -204868, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: no item_size nor item_sample supplied" },
 { -204861, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: invalid storage supplied" },
 { -204853, "src/libfrozen/data/allocator/fixed/allocator_fixed_t.c: calloc failed" },
