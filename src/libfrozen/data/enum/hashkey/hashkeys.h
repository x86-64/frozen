...
#define HK_VALUE_control_key 55015
#define HK_VALUE_convert 15734
...
typedef enum hashkey_t {
      ...
      HK_control_key = HK_VALUE_control_key, 
      HK_convert = HK_VALUE_convert, 
...
keypair_t hashkeys[] = {
      ...
      { "control_key", HK_VALUE_control_key }, 
      { "convert", HK_VALUE_convert }, 
      { "copy", HK_VALUE_copy }, 
