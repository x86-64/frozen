...
*hash_unchain = *Frozenc::hash_unchain;
...
*HK_destination = *Frozenc::HK_destination;
...
*HK_enum_method = *Frozenc::HK_enum_method;
*HK_error = *Frozenc::HK_error;
*HK_exclusive = *Frozenc::HK_exclusive;
*HK_fatal = *Frozenc::HK_fatal;
...
*HK_offset_key = *Frozenc::HK_offset_key;
...
*HK_output_out = *Frozenc::HK_output_out;
...
*HK_req_count = *Frozenc::HK_req_count;
*HK_req_read = *Frozenc::HK_req_read;
*HK_req_rebuild = *Frozenc::HK_req_rebuild;
*HK_req_rebuild_destination = *Frozenc::HK_req_rebuild_destination;
*HK_req_rebuild_enable = *Frozenc::HK_req_rebuild_enable;
*HK_requery_after_rebuild = *Frozenc::HK_requery_after_rebuild;
*HK_request = *Frozenc::HK_request;
*HK_ret = *Frozenc::HK_ret;
*HK_retry = *Frozenc::HK_retry;
*HK_retry_request = *Frozenc::HK_retry_request;
