AC_DEFUN([FROZEN_BACKEND],[
	...
	if test "${enable_backend$1}" = "yes"; then
		BACKEND_DIR_$1="$2"
		BACKEND_DEP_$1="$4"
		BACKEND_OBJECTS_[]backend_dir()="$BACKEND_OBJECTS_[]backend_dir() libfrozen_backend_$1_la-$1.lo"
		BACKEND_SELECTED="$BACKEND_SELECTED $1"

		AC_SUBST([BACKEND_OBJECTS_]backend_dir())
	fi
	...
	if test "$BACKEND_MAKEFILE_[]backend_dir()" = ""; then
		...
		BACKEND_LIBS_SELECTED="$BACKEND_LIBS_SELECTED $2/libfrozen_backend_$1.la"
