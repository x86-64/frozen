...
AC_DEFUN([FROZEN_DATA_END],[
	...
	data_enum_file=src/libfrozen/core/data_selected_enum.h
	data_enum_swig_file=src/lang/datatypes.i
	...
	echo "/* Autogenerated file. Don't edit */" > $data_enum_file
	...
	for h in $DATA_SELECTED; do
		...
		h_upper=$( echo "$h" | tr "a-z" "A-Z" | sed "s#_##g")
		echo "   TYPE_$h_upper = $m_id," >> $data_enum_file
	done;
