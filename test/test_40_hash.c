...
START_TEST (test_hash){
	...
	fail_unless(strcmp(key1->data.ptr, "value1") == 0, "hash found wrong entry");
	fail_unless(strcmp(key2->data.ptr, "value2") == 0, "hash found wrong entry");
	fail_unless(strcmp(key3->data.ptr, "value3") == 0, "hash found wrong entry");
	fail_unless(strcmp(key4->data.ptr, "value4") == 0, "hash found wrong entry");
	...
	fail_unless(strcmp(key2_n->data.ptr, "value_next_2") == 0,             "assigned hash found wrong entry");
	fail_unless( (key3 = hash_find(hash, 3))   != NULL,    "assigned hash not found existing entry");
	fail_unless(strcmp(key3->data.ptr, "value3") == 0,                   "assigned hash found wrong entry");
